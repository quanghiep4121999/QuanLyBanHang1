...
public class HoaDonChiTietDAO {
    ...
    public static final String SQL_HOA_DON_CHI_TIET ="CREATE TABLE HoaDonChiTiet (maHDCT INTEGER PRIMARY KEY AUTOINCREMENT, maHoaDon text NOT NULL, maSanPham text NOT NULL, soLuong INTEGER);";
    ...
    public int inserHoaDonChiTiet(HoaDonChiTiet hd){
        ...
        values.put("maSanPham",hd.getSanPham().getMaSanPham());
    ...
    public List<HoaDonChiTiet> getAllHoaDonChiTiet(){
        ...
        String sSQL = "SELECT maHDCT, HoaDon.maHoaDon,HoaDon.ngayMua, " +
                "SanPham.maSanPham, SanPham.maLoaiHang, SanPham.tenSanPham, SanPham.gia, " +
                "Ca.soLuong,HoaDonChiTiet.soLuong FROM HoaDonChiTiet INNER JOIN HoaDon " +
                "on HoaDonChiTiet.maHoaDon = HoaDon.maHoaDon INNER JOIN SanPham on SanPham.maSanPham = HoaDonChiTiet.maSanPham";
        ...
        try {
            while (c.isAfterLast()==false){
                ...
                ee.setSanPham(new SanPham(c.getString(3),c.getString(4),c.getString(5),c.getInt(6),c.getInt(7)));
                ee.setSoLuongMua(c.getInt(8));
      ...
      public List<HoaDonChiTiet> getAllHoaDonChiTietByID(String maHoaDon){
        ...
        String sSQL = "SELECT maHDCT, HoaDon.maHoaDon,HoaDon.ngayMua, " +
                "SanPham.maSanPham, SanPham.maLoaiHang, SanPham.tenSanPham, SanPham.gia, " +
                "SanPham.soLuong,HoaDonChiTiet.soLuong FROM HoaDonChiTiet INNER JOIN HoaDon " +
                "on HoaDonChiTiet.maHoaDon = HoaDon.maHoaDon INNER JOIN SanPham on SanPham.maSanPham = HoaDonChiTiet.maSanPham where HoaDonChiTiet.maHoaDon='"+maHoaDon+"'";
        Cursor c = db.rawQuery(sSQL, null);
        c.moveToFirst();
        try {
            while (c.isAfterLast()==false){
     ...
     public int updateHoaDonChiTiet(HoaDonChiTiet hd){
        ...
        values.put("mahoadon",hd.getHoaDon().getMaHoaDon());
        values.put("maCa",hd.getSanPham().getMaSanPham());
        values.put("soLuong",hd.getSoLuongMua());
    ...
    public boolean checkHoaDon(String maHoaDon){
        ...
        double doanhThu = 0;
        String sSQL ="SELECT SUM(tongtien) from (SELECT SUM(SanPham.gia * HoaDonChiTiet.soLuong) as 'tongtien' " +
                "FROM HoaDon INNER JOIN HoaDonChiTiet on HoaDon.maHoaDon = HoaDonChiTiet.maHoaDon " +
                "INNER JOIN SanPham on HoaDonChiTiet.maSanPham = SanPham.maSanPham where HoaDon.ngayMua = date('now') GROUP BY HoaDonChiTiet.maSanPham)tmp";
        Cursor c = db.rawQuery(sSQL,null);
        c.moveToFirst();
        while (c.isAfterLast()==false){
        ...
        String sSQL ="SELECT SUM(tongtien) from (SELECT SUM(SanPham.gia * HoaDonChiTiet.soLuong) as 'tongtien' " +
                "FROM HoaDon INNER JOIN HoaDonChiTiet on HoaDon.maHoaDon = HoaDonChiTiet.maHoaDon " +
                "INNER JOIN SanPham on HoaDonChiTiet.maSanPham = SanPham.maSanPham where strftime('%m',HoaDon.ngayMua) = strftime('%m','now') GROUP BY HoaDonChiTiet.maSanPham)tmp";
        Cursor c = db.rawQuery(sSQL, null);
        c.moveToFirst();
        while (c.isAfterLast()==false){
            doanhThu = c.getDouble(0);
        ...
        String sSQL ="SELECT SUM(tongtien) from (SELECT SUM(SanPham.gia * HoaDonChiTiet.soLuong) as 'tongtien' " +
                "FROM HoaDon INNER JOIN HoaDonChiTiet on HoaDon.maHoaDon = HoaDonChiTiet.maHoaDon " +
                "INNER JOIN SanPham on HoaDonChiTiet.maSanPham = SanPham.maSanPham where strftime('%Y',HoaDon.ngayMua) = strftime('%Y','now') GROUP BY HoaDonChiTiet.maSanPham)tmp";
        Cursor c = db.rawQuery(sSQL, null);
        c.moveToFirst();
        while (c.isAfterLast()==false){
            doanhThu = c.getDouble(0);
